...
/* the variable arrays */
XXDouble xx_MEMORY[0 + 10 + 4 + 14 + 4 + 4 + 1];
...
XXDouble* xx_s = xx_MEMORY + 0 + 10 + 4 + 14;		/* states */
XXDouble *xx_R = xx_MEMORY + 0 + 10 + 4 + 14 + 4;		/* rates (or new states) */
...
void XXModelInitialize (void)
{
	...
	xx_P[4] = 100.0;		/* Pipe\R\r */
	xx_P[5] = 0.001;		/* WaterTank1\Tank1\area */
	xx_P[6] = 0.1;		/* WaterTank2\I1\i */
	xx_P[7] = 10000.0;		/* WaterTank2\R1\r */
...
void XXCalculateDynamic (void)
{
	...
	/* flow = WaterTank2\I1\p.f; */
	xx_V[13] = xx_V[9];

	/* Pipe\I\i = (WaterTank1\Tank1\state + WaterTank2\Tank2\state) + Pipe\I\massInPipe; */
	xx_V[5] = (xx_s[1] + xx_s[3]) + xx_P[3];
